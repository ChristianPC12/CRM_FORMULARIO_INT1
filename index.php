...
<body>
  <div class="form-container">
    ...
    <div class="header-content">
      ...
      <p class="instrucciones">Este formulario tiene como objetivo recopilar la información necesaria para registrar a los clientes que recibirán la <strong>tarjeta VIP</strong> del restaurante <em>Bastos</em>. Al completar este formulario, quedarás oficialmente inscrito en nuestro programa VIP y podrás comenzar a disfrutar de beneficios exclusivos, como un trago de cortesía o un descuento especial en el día de tu cumpleaños (a elección del cliente), así como el acceso prioritario a promociones y eventos especiales pensados para nuestros comensales más fieles.</p>
      <p class="instrucciones">La información que nos brindes será utilizada únicamente con fines internos para ofrecerte un servicio más personalizado y una mejor experiencia en tus visitas al restaurante.</p>
      <p class="instrucciones">El tiempo estimado para completar este formulario es de <strong>1 a 2 minutos</strong>.</p>
    </div>
    ...
    <form method="POST" action="" class="formulario-vip">
  ...
  <!-- Resto de provincias solo con nombre principal -->
